...
def import_train_test_calc(rs = None):
    ...
    Y_train = pd.read_sql_query('''SELECT * FROM Y_train''' + str(rs or ""), connection)
    X_train = pd.read_sql_query('''SELECT * FROM X_train''' + str(rs or ""), connection)
    Y_test = pd.read_sql_query('''SELECT * FROM Y_test''' + str(rs or ""), connection)
    X_test = pd.read_sql_query('''SELECT * FROM X_test''' + str(rs or ""), connection)
