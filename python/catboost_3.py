...
#This Skript calculates the best catboost model with a random split of 0.8/0.2 and dropping the year
...
def catboost_regressor():
    ...
    model = CatBoostRegressor(loss_function='RMSE', depth=8,
                                  learning_rate=0.05, iterations=1200, od_type='Iter', od_wait=10)
    ...
    model.save_model("./models/catboost/catboost_model3", format="cbm")
